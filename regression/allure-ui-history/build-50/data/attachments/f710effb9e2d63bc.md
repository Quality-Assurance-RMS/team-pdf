...
- Name: UI/UserManagement/table-columns-visible.spec.ts >> User Management — Table Columns >> TC1 — All table column headers are visible
- Location: tests/UI/UserManagement/table-columns-visible.spec.ts:20:7
