...
- Name: API/transaction-api.spec.ts >> Transaction API — Full Coverage >> TC-TXN-004 — Transaction List: Default today (sorted by trnx_date desc)
- Location: tests/API/transaction-api.spec.ts:370:7

# Error details

```
Error: TC-TXN-004 — expected HTTP 200, got 400
