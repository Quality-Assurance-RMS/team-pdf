...
- Name: UI/UserManagement/status-filter-visible.spec.ts >> User Management — Status Filter >> TC2 — "All Status" filter dropdown is visible
- Location: tests/UI/UserManagement/status-filter-visible.spec.ts:19:7
