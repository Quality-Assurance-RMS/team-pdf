...
- Name: UI/UserManagement/heading-visible.spec.ts >> User Management — Page Heading >> TC1 — "User Management" heading and user count are visible
- Location: tests/UI/UserManagement/heading-visible.spec.ts:20:7
