...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> SPR Fetcher Service >> TC-SF-003 — GET /api/v1/fetch/status: service="spr-fetcher-service" and status="UP"
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:868:7

# Error details

```
Error: TC-SF-003 — expected 200, got 504
