...
```
Error: [BUG-REVT-03] summary[0] "Total Transactions" .value must be a number (or contain one) â€” got formatted string "KES 81,204,737"
...
```
Error: [BUG-REVT-03] summary[1] "Successful" .value must be a number (or contain one) â€” got formatted string "KES 81,192,926"
