...
- Name: API/deep-regression-api.spec.ts >> Analytics API — Deep Tests >> TC-ANA-006 — Analytics field types: all numeric fields must be numbers not strings
- Location: tests/API/deep-regression-api.spec.ts:617:7
