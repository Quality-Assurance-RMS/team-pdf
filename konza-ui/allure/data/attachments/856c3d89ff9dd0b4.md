...
- Name: UI/Invoice/inv-tbl-tc2-table-rows-loaded.spec.ts >> Invoice — Table Rows >> TC2 — Invoice table rows are loaded
- Location: tests/UI/Invoice/inv-tbl-tc2-table-rows-loaded.spec.ts:20:7
