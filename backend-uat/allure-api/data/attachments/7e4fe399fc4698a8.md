...
- Name: API/backend-tests/backend-transaction-api.spec.ts >> Transaction API — Full Coverage >> TC-TXN-006 — Transaction List: Search by keyword "CONF-MAY26"
- Location: tests/API/backend-tests/backend-transaction-api.spec.ts:569:7

# Error details

```
Error: TC-TXN-006 — expected HTTP 200, got 400
