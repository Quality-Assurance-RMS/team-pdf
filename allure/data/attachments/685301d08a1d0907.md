...
- Name: UI/Login/login-auth-tc3-wrong-password-rejected.spec.ts >> Login — Authentication >> TC3 — Wrong password with a valid email is rejected
- Location: tests/UI/Login/login-auth-tc3-wrong-password-rejected.spec.ts:18:7
