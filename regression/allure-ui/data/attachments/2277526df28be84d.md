...
- Name: UI/Dashboard/nav-transactions-link.spec.ts >> Dashboard — Sidebar Navigation >> TC3 — Clicking "Transactions" navigates to /transaction
- Location: tests/UI/Dashboard/nav-transactions-link.spec.ts:29:7
