...
- Name: API/backend-tests/backend-analytics-dashboard-summary.spec.ts >> Backend (Konza) – Analytics Dashboard Summary >> TC-ASUM-015 – Response-Time SLA: must respond within 2 000 ms
- Location: tests/API/backend-tests/backend-analytics-dashboard-summary.spec.ts:963:7
