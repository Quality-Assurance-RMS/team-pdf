...
- Name: UI/Dashboard/kpi-cards-percent-change-badge.spec.ts >> Dashboard — KPI Cards >> TC3 — KPI cards show a percentage change badge
- Location: tests/UI/Dashboard/kpi-cards-percent-change-badge.spec.ts:36:7
