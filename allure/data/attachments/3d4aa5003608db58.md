...
- Name: UI/Dashboard/dash-kpi-tc5-kpi-cards-successful-payments-range.spec.ts >> Dashboard — KPI Cards >> TC5 — Successful Transactions percentage is between 0 and 100
- Location: tests/UI/Dashboard/dash-kpi-tc5-kpi-cards-successful-payments-range.spec.ts:35:7
