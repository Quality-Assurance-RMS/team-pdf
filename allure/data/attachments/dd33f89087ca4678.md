...
- Name: UI/Dashboard/dash-nav-tc5-nav-settlements-link.spec.ts >> Dashboard — Sidebar Navigation >> TC5 — Clicking "Settlements" navigates to the Settlements page
- Location: tests/UI/Dashboard/dash-nav-tc5-nav-settlements-link.spec.ts:29:7
