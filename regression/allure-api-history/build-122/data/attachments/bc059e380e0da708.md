...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> TC-OT-007 — DELETE /api/v1/token/cache: Returns 204 No Content with valid auth
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:402:7

# Error details

```
Error: DELETE /token/cache must return 204, got 502
