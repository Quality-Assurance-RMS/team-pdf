...
```
Error: [BUG-REVT-03] summary[0] "Total Transactions" .value must be a number (or contain one) â€” got formatted string "KES 81,196,687"
...
```
Error: [BUG-REVT-03] summary[1] "Successful" .value must be a number (or contain one) â€” got formatted string "KES 81,184,877"
