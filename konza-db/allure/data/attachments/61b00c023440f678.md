...
Received string:  "http://sso.uat.konza/signin/totp/"
Timeout: 15000ms

Call log:
  - Expect "toHaveURL" with timeout 15000ms
    33 × unexpected value "http://sso.uat.konza/signin/totp/"
...
- navigation:
  ...
  - link "FAQ":
    - /url: /#faq
- main:
  - text: Republic Of Kenya Ministry Of National Treasury & Economic Planning
  ...
  - text:  Your details Identity check  Credentials ID and password  Verify Two-factor code
- contentinfo:
