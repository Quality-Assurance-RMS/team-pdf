...
- Name: UI/Transactions/txn-tbl-tc2-table-rows-loaded.spec.ts >> Transactions — Table Rows Loaded >> TC2 — Table loads with at least one transaction row
- Location: tests/UI/Transactions/txn-tbl-tc2-table-rows-loaded.spec.ts:20:7
