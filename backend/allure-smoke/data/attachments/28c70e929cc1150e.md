...
- Name: API/smoke/smoke-dashboard-revenue-trend.spec.ts >> Smoke â€” Dashboard Revenue Trend >> TC-DREVT-007 â€” BUG-REVT-06: isPostive for "Failed" must not be false when change is "+0%"
- Location: tests/API/smoke/smoke-dashboard-revenue-trend.spec.ts:585:7

# Error details

```
Error: [BUG-REVT-06] "Total Transactions": positive change="+100.0%" must have isPostive=true
...
```
Error: [BUG-REVT-06] "Successful": positive change="+100.0%" must have isPostive=true
