...
- Name: UI/Invoice/inv-flt-tc3-method-filter-dropdown.spec.ts >> Invoice — Method Filter Dropdown >> TC3 — Method filter dropdown is visible
- Location: tests/UI/Invoice/inv-flt-tc3-method-filter-dropdown.spec.ts:19:7
