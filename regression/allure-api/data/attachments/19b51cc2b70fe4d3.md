...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> TC-OT-004 — GET /api/v1/token: expires_at is a future ISO 8601 timestamp
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:276:7

# Error details

```
Error: TC-OT-004 — expected 200, got 500
