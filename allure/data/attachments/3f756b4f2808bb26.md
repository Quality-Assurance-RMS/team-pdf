...
- Name: UI/Dashboard/gateway-payments-heading-visible.spec.ts >> Dashboard — Gateway Payments >> TC1 — "Gateway Payments" section heading is visible
- Location: tests/UI/Dashboard/gateway-payments-heading-visible.spec.ts:29:7
