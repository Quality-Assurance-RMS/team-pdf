...
- Name: UI/Reports/rpt-kpi-tc1-kpi-cards-visible.spec.ts >> Reports — Transaction Status Cards >> TC1 — All five transaction status cards are visible
- Location: tests/UI/Reports/rpt-kpi-tc1-kpi-cards-visible.spec.ts:20:7
