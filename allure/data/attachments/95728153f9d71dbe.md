...
- Name: UI/Dashboard/revenue-chart-all-legend-items.spec.ts >> Dashboard — Monthly Revenue Chart >> TC2 — All KES chart legend items are visible
- Location: tests/UI/Dashboard/revenue-chart-all-legend-items.spec.ts:35:7
