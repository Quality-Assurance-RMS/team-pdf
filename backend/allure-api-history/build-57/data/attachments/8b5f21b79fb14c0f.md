...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> TC-OT-002 — GET /api/v1/token: access_token is a valid RS256 JWT
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:201:7

# Error details

```
Error: TC-OT-002 — expected 200, got 500
