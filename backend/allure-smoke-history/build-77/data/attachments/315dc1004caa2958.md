...
- Name: API/smoke/smoke-analytics-dashboard-summary.spec.ts >> Smoke – Analytics Dashboard Summary >> TC-ASUM-013 – Field types: all today.* fields must be non-negative numbers
- Location: tests/API/smoke/smoke-analytics-dashboard-summary.spec.ts:864:7
