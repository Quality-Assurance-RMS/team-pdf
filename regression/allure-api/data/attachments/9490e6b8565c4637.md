...
- Name: API/deep-regression-api.spec.ts >> Transaction API — Edge Cases (requires valid TRANSACTION_API_TOKEN) >> [BUG-TXN-006] TC-TXN-006 — total_refunds missing change_direction field
- Location: tests/API/deep-regression-api.spec.ts:1264:7
