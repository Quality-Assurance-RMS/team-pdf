...
- Name: UI/Settings/set-tab-tc1-tabs-visible.spec.ts >> Settings — Tabs >> TC1 — Profile Settings, Security, and Notifications tabs are visible
- Location: tests/UI/Settings/set-tab-tc1-tabs-visible.spec.ts:20:7
