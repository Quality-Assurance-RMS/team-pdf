...
- Name: UI/Transactions/txn-tbl-tc1-table-columns-visible.spec.ts >> Transactions — Table Columns >> TC1 — All table column headers are visible
- Location: tests/UI/Transactions/txn-tbl-tc1-table-columns-visible.spec.ts:20:7
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    11 × unexpected value "https://rms.uat.konza/auth/login"
