...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> TC-OT-001 — GET /api/v1/token: Returns 200 with complete KCB token object
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:156:7

# Error details

```
Error: TC-OT-001 — expected 200, got 500
