...
- Name: UI/Dashboard/nav-reports-link.spec.ts >> Dashboard — Sidebar Navigation >> TC6 — Clicking "Reports" navigates to the Reports page
- Location: tests/UI/Dashboard/nav-reports-link.spec.ts:29:7
