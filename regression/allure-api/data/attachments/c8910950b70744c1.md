...
- Name: API/backend-tests/backend-deep-regression-api.spec.ts >> Transaction API — Edge Cases (requires valid TRANSACTION_API_TOKEN) >> [BUG-TXN-006] TC-TXN-006 — total_refunds missing change_direction field
- Location: tests/API/backend-tests/backend-deep-regression-api.spec.ts:1272:7
