...
- Name: UI/Dashboard/nav-logout-redirect.spec.ts >> Dashboard — Sidebar Navigation >> TC7 — Clicking "Logout" redirects to the login page
- Location: tests/UI/Dashboard/nav-logout-redirect.spec.ts:37:7
