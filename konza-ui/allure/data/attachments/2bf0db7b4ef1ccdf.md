...
- Name: UI/Transactions/txn-act-tc1-view-detail-action.spec.ts >> Transactions — View Detail Action >> TC1 — Eye icon opens transaction detail with matching Transaction ID
- Location: tests/UI/Transactions/txn-act-tc1-view-detail-action.spec.ts:20:7
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    6 × unexpected value "https://rms.uat.konza/auth/login"
