...
- Name: API/backend-tests/backend-deep-regression-api.spec.ts >> Transaction API — Edge Cases (requires valid TRANSACTION_API_TOKEN) >> [BUG-TXN-001] TC-TXN-001 — Transaction list: negative page (-1) must return 400
- Location: tests/API/backend-tests/backend-deep-regression-api.spec.ts:1093:7
