...
- Name: API/smoke/smoke-dashboard-today-payments.spec.ts >> Smoke â€" Dashboard Today Payments >> TC-DTPAY-010 â€" BUG-TPAY-09: Unknown query parameters must not be silently ignored
- Location: tests/API/smoke/smoke-dashboard-today-payments.spec.ts:908:7

# Error details

```
Error: [BUG-TPAY-09a] ?date= parameter is silently ignored â€" endpoint should filter by date or reject the param with 400
...
```
Error: [BUG-TPAY-09b] Unknown query params should return 400, not 200
