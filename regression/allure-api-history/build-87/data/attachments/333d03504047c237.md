...
- Name: API/backend-tests/backend-dashboard-summary.spec.ts >> Backend (Konza) â€” Dashboard Summary >> TC-DSUM-004 â€” Field types: amounts are numbers, rates are numbers
- Location: tests/API/backend-tests/backend-dashboard-summary.spec.ts:340:7
