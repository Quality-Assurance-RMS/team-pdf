...
- Name: UI/Dashboard/gateway-payments-chart-legend.spec.ts >> Dashboard — Gateway Payments >> TC6 — Success vs Failure chart legend shows "Success" and "Failure" entries
- Location: tests/UI/Dashboard/gateway-payments-chart-legend.spec.ts:29:7
