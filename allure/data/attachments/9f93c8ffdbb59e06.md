...
- Name: UI/Settings/set-tab-tc3-security-tab-navigation.spec.ts >> Settings — Security Tab Navigation >> TC3 — Clicking Security tab changes the active panel
- Location: tests/UI/Settings/set-tab-tc3-security-tab-navigation.spec.ts:20:7
