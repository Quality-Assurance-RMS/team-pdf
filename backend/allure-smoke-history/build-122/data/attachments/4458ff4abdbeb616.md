...
- Name: API/smoke/smoke-transaction-list.spec.ts >> Smoke â€" Transaction List >> TC-SMK-005 â€" List: period=month filtered by status=SUCCESS and method=MPESA
- Location: tests/API/smoke/smoke-transaction-list.spec.ts:229:7

# Error details

```
Error: TC-SMK-005 â€" HTTP 200 expected
