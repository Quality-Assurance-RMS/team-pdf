...
- Name: UI/Invoice/inv-flt-tc2-status-filter-dropdown.spec.ts >> Invoice — Status Filter Dropdown >> TC2 — Status filter dropdown is visible
- Location: tests/UI/Invoice/inv-flt-tc2-status-filter-dropdown.spec.ts:19:7
