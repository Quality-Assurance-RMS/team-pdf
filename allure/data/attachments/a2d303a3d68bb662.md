...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    28 × unexpected value "https://api.rms.dev.demo-fsit.com/auth/sso/callback?code=MZmQTXd58YxAGO4xXfv8qGXE5wYt5s&state=52e4aab7-d44d-437d-b4d3-8b47c90fe9da"
    5 × unexpected value "https://api.rms.dev.demo-fsit.com/auth/login"
...
- region "Notifications alt+T":
  - list:
    - listitem:
      - img
      - text: Failed to retrieve user info from Taifaa SSO.
```
