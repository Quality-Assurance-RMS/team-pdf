...
- Name: UI/Dashboard/dash-gp-tc6-gateway-payments-chart-legend.spec.ts >> Dashboard — Gateway Payments >> TC6 — Success vs Failure chart legend shows "Success" and "Failure" entries
- Location: tests/UI/Dashboard/dash-gp-tc6-gateway-payments-chart-legend.spec.ts:29:7
