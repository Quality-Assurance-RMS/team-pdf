...
- Name: UI/Dashboard/gateway-payments-success-vs-failure-chart.spec.ts >> Dashboard — Gateway Payments >> TC5 — "Success vs Failure by Method" chart label is visible
- Location: tests/UI/Dashboard/gateway-payments-success-vs-failure-chart.spec.ts:35:7
