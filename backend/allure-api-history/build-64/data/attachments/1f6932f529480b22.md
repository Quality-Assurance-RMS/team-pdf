...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> TC-OT-003 — GET /api/v1/token: token_type is exactly "Bearer"
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:244:7

# Error details

```
Error: TC-OT-003 — expected 200, got 500
