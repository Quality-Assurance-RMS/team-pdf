...
- Name: API/smoke/smoke-dashboard-monthly-revenue.spec.ts >> Smoke â€” Dashboard Monthly Revenue >> TC-DMREV-012 â€” BUG-MREV-09: CORS Access-Control-Allow-Origin: * is overly permissive
- Location: tests/API/smoke/smoke-dashboard-monthly-revenue.spec.ts:767:7

# Error details

```
Error: [BUG-MREV-09a] ACAO must not be wildcard "*"
...
```
Error: [BUG-MREV-09b] CORS must not allow destructive methods: DELETE, POST, PUT, PATCH
