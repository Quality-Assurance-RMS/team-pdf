...
- Name: UI/UserManagement/activation-toggle-visible.spec.ts >> User Management — Activation Toggles >> TC1 — Activation toggle is present in the first user row
- Location: tests/UI/UserManagement/activation-toggle-visible.spec.ts:20:7
