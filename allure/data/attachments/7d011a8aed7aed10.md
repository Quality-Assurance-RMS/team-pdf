...
- Name: UI/Dashboard/dash-nav-tc2-nav-dashboard-active.spec.ts >> Dashboard — Sidebar Navigation >> TC2 — Dashboard nav item is marked as active on /dashboard
- Location: tests/UI/Dashboard/dash-nav-tc2-nav-dashboard-active.spec.ts:36:7
