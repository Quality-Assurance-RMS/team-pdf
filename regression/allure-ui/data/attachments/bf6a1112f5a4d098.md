...
- Name: UI/Dashboard/gateway-payments-by-method-chart.spec.ts >> Dashboard — Gateway Payments >> TC4 — "Transactions by Payment Method" chart label is visible
- Location: tests/UI/Dashboard/gateway-payments-by-method-chart.spec.ts:35:7
