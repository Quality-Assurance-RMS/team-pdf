...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> SPR Fetcher Service >> TC-SF-001 — GET /api/v1/fetch/status: Returns 200 with service status object
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:790:7

# Error details

```
Error: TC-SF-001 — expected 200, got 504
