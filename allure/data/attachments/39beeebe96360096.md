...
- Name: UI/Dashboard/gateway-payments-success-rate.spec.ts >> Dashboard — Gateway Payments >> TC3 — Success Rate metric shows a valid percentage (0–100%)
- Location: tests/UI/Dashboard/gateway-payments-success-rate.spec.ts:36:7
