...
```ts
  88  | function getWithMethod(method: 'post' | 'put' | 'delete' | 'patch') {
  89  |   return (supertest(BASE_URL) as unknown as Record<string, (p: string) => supertest.Test>)
  90  |     [method](ENDPOINT)
  91  |     .set('Authorization', `Bearer ${BEARER_TOKEN}`)
  92  |     .set('Accept', 'application/json');
  93  | }
  94  | 
  95  | // â”€â”€ Logger â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  96  | 
  97  | function logResponse(tcId: string, res: supertest.Response, label = '') {
  98  |   const body = res.body as RevenueTrendBody;
  99  |   const d    = body?.data;
  100 | 
  101 |   console.log(`\n${'â”€'.repeat(70)}`);
  102 |   console.log(`[${tcId}]${label ? ' ' + label : ''} GET ${BASE_URL}${ENDPOINT}`);
  103 |   console.log(`  â–º HTTP Status   : ${res.status}`);
  104 |   console.log(`  â–º Content-Type  : ${res.headers['content-type'] ?? 'N/A'}`);
  105 |   if (d) {
  106 |     console.log(`  â–º labels        : [${d.labels?.join(', ')}]  (${d.labels?.length} entries)`);
