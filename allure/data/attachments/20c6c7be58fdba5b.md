...
- Name: UI/Login/login-auth-tc2-invalid-credentials-error.spec.ts >> Login — Authentication >> TC2 — Invalid credentials show an error and stay on login
- Location: tests/UI/Login/login-auth-tc2-invalid-credentials-error.spec.ts:16:7
...
Call log:
  ...
  - attempting fill action
    ...
    - retrying fill action
      - waiting 100ms
    302 × waiting for element to be visible, enabled and editable
        - element is not enabled
      - retrying fill action
        - waiting 500ms
