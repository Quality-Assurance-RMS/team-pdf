...
- Name: API/deep-regression-api.spec.ts >> Dashboard API — Edge Cases (requires valid DASHBOARD_API_TOKEN) >> [BUG-DB-003] TC-DB-003 — Impossible date (Feb-30) causes HTTP 500 instead of 400
- Location: tests/API/deep-regression-api.spec.ts:780:7
