...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> SPR Fetcher Service >> [BUG-SF-001] TC-SF-006 — GET /api/v1/fetch/status: No auth returns 200 (sensitive data exposed without auth)
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:992:7

# Error details

```
Error: [BUG-SF-001] No-auth status must return 401/403, got 200
