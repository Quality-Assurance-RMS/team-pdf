...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> API Gateway & Security >> [BUG-GW-001] TC-GW-001 — CORS allow-origin must not be wildcard "*" on oauth-token routes
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:1359:7
