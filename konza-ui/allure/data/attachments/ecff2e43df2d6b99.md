...
- Name: UI/Reports/rpt-fin-tc1-financial-reports-section-visible.spec.ts >> Reports — Settlement & Payout Overview >> TC1 — Settlement & Payout Overview section heading is visible
- Location: tests/UI/Reports/rpt-fin-tc1-financial-reports-section-visible.spec.ts:20:7
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    32 × unexpected value "https://rms.uat.konza/auth/login"
