...
- Name: UI/Transactions/txn-flt-tc2-status-filter-dropdown.spec.ts >> Transactions — Status Filter Dropdown >> TC2 — Status filter dropdown is visible
- Location: tests/UI/Transactions/txn-flt-tc2-status-filter-dropdown.spec.ts:19:7
