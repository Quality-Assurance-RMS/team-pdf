...
- Name: API/smoke/smoke-analytics-dashboard-summary.spec.ts >> Smoke – Analytics Dashboard Summary >> TC-ASUM-012 – BUG-ASUM-11: CORS wildcard origin on analytics financial endpoint
- Location: tests/API/smoke/smoke-analytics-dashboard-summary.spec.ts:832:7

# Error details

```
Error: [BUG-ASUM-11] ACAO must not be wildcard "*"
