...
- Name: API/transaction-api.spec.ts >> Transaction API — Full Coverage >> TC-TXN-005 — Transaction List: Filtered by status=SUCCESS and method=MPESA
- Location: tests/API/transaction-api.spec.ts:465:7
