...
- Name: UI/Dashboard/dash-rc-tc1-revenue-chart-heading-visible.spec.ts >> Dashboard — Monthly Revenue Chart >> TC1 — "Monthly Revenue for All Services" heading is visible
- Location: tests/UI/Dashboard/dash-rc-tc1-revenue-chart-heading-visible.spec.ts:29:7
