...
- Name: UI/Settings/set-tab-tc2-profile-settings-default-active-tab.spec.ts >> Settings — Default Active Tab >> TC2 — Profile Settings tab is active by default
- Location: tests/UI/Settings/set-tab-tc2-profile-settings-default-active-tab.spec.ts:20:7
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    26 × unexpected value "https://rms.uat.konza/auth/login"
