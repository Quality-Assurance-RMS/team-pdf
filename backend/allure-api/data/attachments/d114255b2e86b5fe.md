...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> TC-OT-005 — GET /api/v1/token: issued_at < now < expires_at (valid time window)
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:313:7

# Error details

```
Error: TC-OT-005 — expected 200, got 500
