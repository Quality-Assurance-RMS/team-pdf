...
- Name: UI/Settings/set-card-tc1-profile-card-visible.spec.ts >> Settings — Profile Card >> TC1 — Profile card with name, email, and ADMIN role is visible
- Location: tests/UI/Settings/set-card-tc1-profile-card-visible.spec.ts:20:7
