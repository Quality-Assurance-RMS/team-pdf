...
- Name: database-testing/dashboard-kpi-vs-db.spec.ts >> Database Testing — Dashboard KPI reconciliation (Last 30 Days) >> TC3 — Revenue generated (KES and USD) is consistent with the database gross amount
- Location: tests/database-testing/dashboard-kpi-vs-db.spec.ts:108:9

# Error details

```
Error: UI showed KES 21200000, database sum for the last 30 day(s) is KES 13
