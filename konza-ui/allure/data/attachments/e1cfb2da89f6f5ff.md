...
- Name: UI/Invoice/inv-tbl-tc1-table-columns-visible.spec.ts >> Invoice — Table Columns >> TC1 — All table column headers are visible
- Location: tests/UI/Invoice/inv-tbl-tc1-table-columns-visible.spec.ts:21:7
...
Locator: locator('h1, h2, h3').filter({ hasText: /^Invoice$/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('h1, h2, h3').filter({ hasText: /^Invoice$/i })
