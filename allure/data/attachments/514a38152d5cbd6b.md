...
- Name: UI/Dashboard/dash-nav-tc3-nav-transactions-link.spec.ts >> Dashboard — Sidebar Navigation >> TC3 — Clicking "Transactions" navigates to /transaction
- Location: tests/UI/Dashboard/dash-nav-tc3-nav-transactions-link.spec.ts:29:7
