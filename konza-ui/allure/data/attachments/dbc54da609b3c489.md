...
- Name: UI/Invoice/inv-act-tc1-view-detail-action.spec.ts >> Invoice — View Detail Action >> TC1 — Eye icon opens invoice detail with matching Invoice Number
- Location: tests/UI/Invoice/inv-act-tc1-view-detail-action.spec.ts:20:7
