...
- Name: API/oauth-token-spr-fetcher-api.spec.ts >> OAuth Token Service >> [BUG-OT-006] TC-OT-014 — DELETE /api/v1/token: Must return 405 Method Not Allowed (returns 500)
- Location: tests/API/oauth-token-spr-fetcher-api.spec.ts:702:7

# Error details

```
Error: [BUG-OT-006] DELETE /token must return 405, got 504
