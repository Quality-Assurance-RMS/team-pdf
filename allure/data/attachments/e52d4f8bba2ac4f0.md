...
- Name: UI/Settings/set-form-tc1-profile-form-fields-visible.spec.ts >> Settings — Profile Form Fields >> TC1 — All profile form fields are visible
- Location: tests/UI/Settings/set-form-tc1-profile-form-fields-visible.spec.ts:20:7
