...
- Name: UI/Dashboard/dash-kpi-tc7-kpi-cards-greeting-user.spec.ts >> Dashboard — KPI Cards >> TC7 — Dashboard greeting displays the logged-in user name
- Location: tests/UI/Dashboard/dash-kpi-tc7-kpi-cards-greeting-user.spec.ts:36:7
