...
- Name: API/smoke/smoke-transaction-list.spec.ts >> Smoke â€" Transaction List >> TC-SMK-006 â€" List: period=week keyword search q=CONF-MAY26 returns data array
- Location: tests/API/smoke/smoke-transaction-list.spec.ts:307:7

# Error details

```
Error: TC-SMK-006 â€" HTTP 200 expected
