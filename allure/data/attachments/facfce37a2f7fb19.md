...
- Name: UI/Reports/rpt-card-tc1-report-cards-visible.spec.ts >> Reports — Report Cards Visible >> TC1 — All five report cards are visible with subtitles
- Location: tests/UI/Reports/rpt-card-tc1-report-cards-visible.spec.ts:20:7
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    30 × unexpected value "https://api.rms.dev.demo-fsit.com/auth/login"
